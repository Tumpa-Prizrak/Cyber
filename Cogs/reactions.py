...
class ReactionsCommand(commands.Cog):
    ...
    async def get_gif(self, param):
        async with self.session.get(
                f"https://g.tenor.com/v1/search?q={param.replace(' ', '%20')}&key={c.apikey}&limit={str(c.limit)}") as r:
            if r.status == 200:
                while 1:
                    try:
    ...
    async def baka(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def bite(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def cuddle(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def dance(self, ctx, person: typing.Union[nextcord.Member, str] = None):
    ...
    async def drink(self, ctx, person: typing.Union[nextcord.Member, str] = None):
    ...
    async def feed(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def five(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def hit(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def hug(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def kill(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def kiss(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def lick(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def pat(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def poke(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def scare(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def slap(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def spank(self, ctx, person: typing.Union[nextcord.Member, str]):
        r = await self.get_gif('anime spank')
        emb = await self.build_embed(r, ctx.author, 'ударил(а)', person)
        await ctx.send(embed=emb)

    @commands.command(usage='tickle <Человек>', brief='Пощекотать кого-то')
    async def tickle(self, ctx, person: typing.Union[nextcord.Member, str]):
    ...
    async def walk(self, ctx, person: typing.Union[nextcord.Member, str] = None):
